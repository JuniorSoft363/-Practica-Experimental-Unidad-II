...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-3xl font-extrabold text-white tracking-tight">Agregar Nuevo Producto</h1>
            <p class="text-sm text-slate-400">Introduce los datos del nuevo producto del inventario.</p>
        </div>
    </div>
